...
import com.she.apps.databinding.ActivityShowIbprBinding
import com.she.apps.databinding.LayoutFilterBinding
import com.she.apps.presentation.page.adapter.ItemIbprAdapter
...
class ShowIbprActivity : AppCompatActivity() {
    ...
    private fun initListener() {
        binding.apply {
            btPdf.setOnClickListener {
                ...
                pdfConverter.createPdf(scroll, this@ShowIbprActivity, "SheeDemoIbpr${System.currentTimeMillis()}.pdf")
            }
    ...
    private fun createExcelIbprFile() {
        ...
        for (i in listIbpr.indices) {
            ...
            cell.setCellValue(changeDateFormat(listIbpr[i].date.toString(), "yyyy-MM-dd"))
            cell = row1.createCell(2)
            cell.setCellValue(changeDateFormat(listIbpr[i].date.toString(), "HH:mm:ss"))
